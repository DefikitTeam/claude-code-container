// Copied and adapted from zed-industries/claude-code-acp/src/acp-agent.ts
import {
  Agent,
  AgentSideConnection,
  AuthenticateRequest,
    ...
    while (true) {
      ...
      switch (message.type) {
        ...
        case "assistant": {
          ...
          // TODO: Fix type checking for synthetic messages
          // if (
...
async function getAvailableSlashCommands(query: Query): Promise<AvailableCommand[]> {
  ...
  // TODO: Fix supportedCommands method when available in SDK
  try {
...
export function runAcp() {
  new AgentSideConnection(
    ...
    nodeToWebReadable(process.stdin) as any, // TODO: Fix stream type compatibility
  );
}
