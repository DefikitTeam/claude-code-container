// Copied and adapted from zed-industries/claude-code-acp/src/mcp-server.ts
...
import { ClaudeAcpAgent } from "./zed-acp-agent.js";
import { ClientCapabilities, TerminalOutputResponse } from "@zed-industries/agent-client-protocol";
import * as diff from "diff";

import { sleep, unreachable, extractLinesWithByteLimit } from "./zed-utils.js";
...
const SERVER_PREFIX = "mcp__container__";
