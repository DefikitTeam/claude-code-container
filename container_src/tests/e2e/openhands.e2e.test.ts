...
const runReal = process.env.REAL_OPENHANDS === '1' && !!process.env.OPENHANDS_API_KEY;

(runReal ? it : it.skip)('real OpenHands e2e (manual, requires REAL_OPENHANDS=1 and OPENHANDS_API_KEY)', async () => {
