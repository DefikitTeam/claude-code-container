...
export function createACPRoutes(controller: ACPController): Hono {
  ...
  router.post('/initialize', requireJsonBody(), (c) => controller.initialize(c));

  // POST /session/new - Create new session
  router.post('/session/new', requireJsonBody(), (c) => controller.sessionNew(c));
  ...
  router.post('/task/execute', requireJsonBody(), (c) => controller.taskExecute(c));
